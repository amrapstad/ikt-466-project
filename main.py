    ...
    for j, segment in enumerate(dataset):
        ...
        for k, fold in enumerate(segment[0]):
            ...
            for f, filepath in enumerate(segment[0][fold]):
                ...
                ####### visualizing spectrogram (PNG) ######
                #audio_visualizer.audio_mel_spectrogram_png(filepath, class_id)

                ####### visualising audio waveform (PNG) ######
                #audio_visualizer.audio_waveform_png_raw(filepath)
        ...
        for l, fold in enumerate(segment[1]):
            ...
            for f, filepath in enumerate(segment[1][fold]):
                ...
                ###### getting augmented spectrogram for preprocessing ######
